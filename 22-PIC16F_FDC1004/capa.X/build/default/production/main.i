...
void main(void) {
    ...
    I2C_Master_Init();
    lcd_initialize();
    FDC1004_Init(&fdc, (0x03));

    while (1) {

        FDC1004_ConfigureMeasurement(&fdc, 0, 0, capdac_1);
        FDC1004_TriggerMeasurement(&fdc, 0, (0x01));

        if (!FDC1004_ReadMeasurement(&fdc, 0, value_1)) {
            int16_t msb_1 = (int16_t)value_1[0];
            int32_t capacitance_1 = ((int32_t)457) * ((int32_t)msb_1);
            capacitance_1 /= 1000;
