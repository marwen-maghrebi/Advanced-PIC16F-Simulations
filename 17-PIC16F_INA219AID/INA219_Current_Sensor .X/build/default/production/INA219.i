...
void INA219_PowerSave(_Bool on);
# 2 "INA219.c" 2
...
float INA219_GetBusVoltage_V(void) {
    ...
    I2C_Master_Start();
    I2C_Master_Write((0x40 << 1) | 1);
    rawBusVoltage = ((uint16_t)I2C_Read_Byte() << 8);
    I2C_ACK();
    rawBusVoltage |= I2C_Read_Byte();
    I2C_NACK();
    I2C_Master_Stop();
...
float INA219_GetShuntVoltage_mV(void) {
    ...
    I2C_Master_Start();
    I2C_Master_Write((0x40 << 1) | 1);
    rawShuntVoltage = ((uint16_t)I2C_Read_Byte() << 8);
    I2C_ACK();
    rawShuntVoltage |= I2C_Read_Byte();
    I2C_NACK();
    I2C_Master_Stop();
...
float INA219_GetCurrent_mA(void) {
    ...
    I2C_Master_Start();
    I2C_Master_Write((0x40 << 1) | 1);
    rawCurrent = ((uint16_t)I2C_Read_Byte() << 8);
    I2C_ACK();
    rawCurrent |= I2C_Read_Byte();
    I2C_NACK();
    I2C_Master_Stop();
...
float INA219_GetPower_mW(void) {
    ...
    I2C_Master_Start();
    I2C_Master_Write((0x40 << 1) | 1);
    rawPower = ((uint16_t)I2C_Read_Byte() << 8);
    I2C_ACK();
    rawPower |= I2C_Read_Byte();
    I2C_NACK();
    I2C_Master_Stop();
...
void INA219_PowerSave(_Bool on) {
    ...
    I2C_Master_Start();
    I2C_Master_Write((0x40 << 1) | 1);
    config = ((uint16_t)I2C_Read_Byte() << 8);
    I2C_ACK();
