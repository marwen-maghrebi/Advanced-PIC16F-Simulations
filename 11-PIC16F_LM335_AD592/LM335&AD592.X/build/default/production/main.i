...
void read_LM335_temperature(void) {
    ...
    wait_for_conversion();
    float Kelvin = read_ADC_result() * 0.489;
    Celsius_LM335 = Kelvin - 273;
    }
...
void read_AD592_temperature(void) {
    ...
    start_ADC_conversion();
    wait_for_conversion();
    float voltage = read_ADC_result() * (5.0 / 1023.0);
    float Kelvin = voltage / 0.01;
    Celsius_AD592 = Kelvin - 273.15;
...
void display_temperatures(void) {
    ...
    if (Celsius_AD592 < 0) {
        sprintf(message1, "AD592: -%2.1f C", fabsf(Celsius_AD592));
        } else {
    ...
    if (Celsius_LM335 < 0) {
        sprintf(message2, "LM335: -%2.1f C", fabsf(Celsius_LM335));
        } else {
