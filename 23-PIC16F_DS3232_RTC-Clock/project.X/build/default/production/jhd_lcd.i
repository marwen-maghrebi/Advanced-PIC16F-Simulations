...
static void LCD_Send(unsigned char data, unsigned char mode) {
    I2C_Master_Start();
    I2C_Master_Write(_lcd_addr);
    I2C_Master_Write(mode);
...
void LCD_Init(unsigned char lcd_addr) {
    ...
    LCD_Command(0x20 | 0x08 | 0x00 | 0x00);
    _delay((unsigned long)((5)*(16000000/4000.0)));


    LCD_Command(0x08 | _displaycontrol);
    _delay((unsigned long)((5)*(16000000/4000.0)));
