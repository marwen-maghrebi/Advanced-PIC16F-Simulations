...
void MPL3115A2_SetSeaPressure(float SLP) {
    ...
    MPL3115A2_WriteRegister(MPL3115A2_BAR_IN_MSB, (uint8_t)(bar_in >> 8));
    MPL3115A2_WriteRegister(MPL3115A2_BAR_IN_LSB, (uint8_t)(bar_in & 0xFF));
}
