...
void configureComparatorMode(void) {
    ...
    MCP9800_SetConfigResolution(3);
    MCP9800_SetConfigFaultQueue(2);
    MCP9800_SetConfigCompIntMode(0);
    }
...
void configureInterruptMode(void) {
    ...
    MCP9800_SetConfigAlertPolarity(0);
    MCP9800_SetConfigResolution(3);
    MCP9800_SetConfigFaultQueue(1);
    MCP9800_SetConfigCompIntMode(1);
    }
