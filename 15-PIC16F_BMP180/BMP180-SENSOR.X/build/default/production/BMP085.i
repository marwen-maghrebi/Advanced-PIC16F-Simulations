...
uint8_t BMP085_Read8(uint8_t addr) {
    ...
    I2C_Master_Start();
    I2C_Master_Write(0x77 << 1);
    I2C_Master_Write(addr);
    I2C_Master_RepeatedStart();
    I2C_Master_Write((0x77 << 1) | 1);
    data = I2C_Read_Byte();
    I2C_NACK();
    I2C_Master_Stop();
...
__attribute__((inline)) void BMP085_Write8(uint8_t addr, uint8_t data) {
    I2C_Master_Start();
    I2C_Master_Write(0x77 << 1);
    I2C_Master_Write(addr);
...
void BMP085_Init(uint8_t mode) {
    ...
    ac1 = (int16_t)BMP085_Read16(0xAA);
    ac2 = (int16_t)BMP085_Read16(0xAC);
    ac3 = (int16_t)BMP085_Read16(0xAE);
    ac4 = (uint16_t)BMP085_Read16(0xB0);
    ac5 = (uint16_t)BMP085_Read16(0xB2);
    ac6 = (uint16_t)BMP085_Read16(0xB4);

    b1 = (int16_t)BMP085_Read16(0xB6);
    b2 = (int16_t)BMP085_Read16(0xB8);

    mb = (int16_t)BMP085_Read16(0xBA);
    mc = (int16_t)BMP085_Read16(0xBC);
    md = (int16_t)BMP085_Read16(0xBE);
    }
...
uint16_t BMP085_ReadRawTemperature(void) {
    BMP085_Write8(0xF4, 0x2E);
    _delay((unsigned long)((5)*(16000000/4000.0)));
    return BMP085_Read16(0xF6);
    }

uint32_t BMP085_ReadRawPressure(void) {
    uint32_t raw;

    BMP085_Write8(0xF4, 0x34 + (oversampling << 6));
    ...
    if (oversampling == 0)
        ...
        _delay((unsigned long)((26)*(16000000/4000.0)));


    raw = BMP085_Read16(0xF6);
    raw <<= 8;
    raw |= BMP085_Read8(0xF6 + 2);
    raw >>= (8 - oversampling);
