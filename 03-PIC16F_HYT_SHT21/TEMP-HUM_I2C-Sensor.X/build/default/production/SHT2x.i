...
# 11 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\include\\c99\\math.h" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\include\\c99\\features.h" 1 3
# 12 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\include\\c99\\math.h" 2 3
...
float SHT2x_GetHumidity(void) {
    float value = (float) SHT2x_ReadSensor(0xE5);
    if (value == 0) {
        return 0;
        }
...
float SHT2x_GetTemperature(void) {
    float value = (float) SHT2x_ReadSensor(0xE3);
    if (value == 0) {
        return -273;
        }
...
float SHT2x_GetDewPoint(void) {
    ...
    float gamma = logf(humidity / 100.0) + 17.62f * temperature / (243.5f + temperature);
