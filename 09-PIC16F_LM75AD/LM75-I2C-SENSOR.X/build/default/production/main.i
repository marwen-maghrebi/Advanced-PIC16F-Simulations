...
int main(void) {
    ...
    while (1) {
        ...
        if (RB0 == 1) {
            ...
            LM75_setDeviceMode(0);
            LM75_setOSPolarity(0);
            LM75_setOSTripTemperature(60.0);
            LM75_setHysteresisTemperature(55.0);
            LM75_setFaultQueue(1);
            hysteresisTemp = LM75_getHysteresisTemperature();
            osTripTemp = LM75_getOSTripTemperature();
            ...
            UART_Write_Text("Safety Mode"
                    ""
                    "");
            LM75_setDeviceMode(1);
            LM75_setOSPolarity(1);
            LM75_setOSTripTemperature(70.0);
            LM75_setHysteresisTemperature(65.0);
            LM75_setFaultQueue(2);
            hysteresisTemp = LM75_getHysteresisTemperature();
            osTripTemp = LM75_getOSTripTemperature();
