...
char LM75_isShutdown(void)
{
    return (LM75_readConfig() & 0x01) ? 1 : 0;
    }

char LM75_getDeviceMode(void)
{
    return (LM75_readConfig() & 0x02) ? 1 : 0;
    }

char LM75_getOSPolarity(void)
{
    return (LM75_readConfig() & 0x04) ? 1 : 0;
    char config = LM75_readConfig();
...
char LM75_getFaultQueue(void)
{
    return (LM75_readConfig() & 0x18) >> 3;
    }


float LM75_getHysteresisTemperature(void)
{
    unsigned char rawTemp = LM75_read(0x02);
    if (rawTemp == -1) return -1000.0f;
...
float LM75_getOSTripTemperature(void)
{
    unsigned char rawTemp = LM75_read(0x03);
    if (rawTemp == -1) return -1000.0f;
